...
python -m spinup.run sapm --env Swimmer-v2 --exp_name Swimmer-sapm0.5 --act_size 128 --min_d 0.3 --scale 0.5 --N_layers 2 --DPP 1 --seed 0 10 20 30 40

#export CUDA_VISIBLE_DEVICES=0
python -m spinup.run sapm --env Swimmer-v2 --exp_name Swimmer-sapm0.2 --act_size 128 --min_d 0.3 --scale 0.2 --N_layers 2 --DPP 1 --seed 0 10 20 30 40 &
